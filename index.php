...
session_start();
//Placeholder to prevent TailwindCSS purge taking away IJP Colours
echo("<p class='w-0 h-0 hover:bg-ijp-1 hover:bg-ijp-2 hover:bg-ijp-3 hover:bg-ijp-4 hover:bg-ijp-5 border-none focus:border-ijp-1 focus:border-ijp-2 focus:border-ijp-3 focus:border-ijp-4 focus:border-ijp-5 bg-ijp-1 bg-ijp-2 bg-ijp-3 bg-ijp-4 bg-ijp-5 text-ijp-1 text-ijp-2 text-ijp-3 text-ijp-4 text-ijp-5'>");
