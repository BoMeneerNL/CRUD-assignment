...
switch ($_SESSION['loginstack']) {
    case "intern":
        ...
        <div class="justify-center justify-items-center grid grid-cols-5 text-xs md:text-sm gap-1 place-items-start h-32 pt-5">
            <div></div>
            <div><div class="hover:bg-gray-500 rounded p-3"><a href="index.php"><img src="assets/img/clogin_int.svg" alt="student_logo_changelogintype" width="25" height="25"><p>' . langkit("chlogin_int") . '</p></a></div><img src="assets/img/line.svg" alt="a line" width="20px" height="30px"></div>
