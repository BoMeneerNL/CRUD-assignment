...
CREATE TABLE `boarddat` ( `boardid` int(100) NOT NULL, `boardtitle` varchar(300) NOT NULL, `boarddesc` varchar(10000) NOT NULL, `boardauthor` varchar(1000) NOT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 0, 'Qm9vdGpl', 'MDAwQDAwMC52b2lkMA==', 'JDJ5JDEwJFd2bjVjemZpeVNKdURUSDJEQjhaRmVLVzdIV0dHcjQwdWFsR0o0WjFrR1VDbkVUejhGamxT', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);
